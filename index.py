...
for dist in distances:
    ...
    print('col=', col) #col position of pixel in 2d array
    print('row=', row) #row position of pixel in 2d array
...
gdf_pcs['Elevation'] = 0
minHeight = min(elevation_profile)#for y axis
maxHeight = max(elevation_profile)#for y axis
#print('axis=',minHeight, maxHeight)
